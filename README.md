...
======================================
IMPORTANT NOTICE:
[ WE HIGHLY RECOMMEND YOU TO USE WINDOWS VERSION OF THE PYTHON SOURCE CODE FOR TESTING AND PRE-COMPILED BINARIES FOR WINDOWS ARE MORE STABLE RUNNING OF THE PROGRAM. FOR MAINTANING CONFIDENTIALITY, THE MAIN SOURCE CODE AND BINARIES ARE PROTECTED BY PASSWORD UNTILL MANUSCRIPT IS ACCEPTED FOR PUBLICATION. THE PASSWORD ARE CASE-SENSITIVE AND ARE GIVEN AS "PASSWORD" in "Availability of Data and Materials" SECTION OF THE SUBMITTED MANUSCRIPT FOR REVIEW ]

For proper text-based Alignment view, we request to use the font "Consolas" in text viewer like "NotePad". Font downlaod link: https://www.wfonts.com/font/consolas  (normally installed by default in operating system but can be choosen under Fonts).  
